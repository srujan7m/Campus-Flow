...
router.delete('/:id', async (req, res) => {
    try {
        ...
        const registrations = await db.collection(COLLECTIONS.EVENTS)
            .doc(eventId)
        ...
        // Delete tickets
        const tickets = await db.collection(COLLECTIONS.EVENTS)
            .doc(eventId)
            .collection('tickets')
            .get();
        ...
        const chunks = await db.collection(COLLECTIONS.EVENTS)
            .doc(eventId)
            .collection('chunks')
            .get();
        ...
        // Delete documents
        const documents = await db.collection(COLLECTIONS.EVENTS)
            .doc(eventId)
